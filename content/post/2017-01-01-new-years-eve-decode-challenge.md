...
<pre>3/24
（获取题干方式同上）
<span lang="EN-US" style="font-size: 12pt; font-family: Consolas; color: #ba0000;">CDEBCEEDBFFBBFDDEDBFFBBFDDCDFEDFBFECCBCEFBBFEDCEFDEECDECBFBFECFF
</span><span style="color: #000000;">解法：
</span>按B=1 C=2 D=3 E=4 F=5的方式把字母换成数字
64位长度1-5数字
2341244315511533431551153323543515422124511543245344234215154255
用棋盘密码（polybius）
...
hqi/jsevensevenhyperfivesixthreerz
第一个有争议的i/j经尝试后是选用j


<span style="color: #99cc00;"><strong>hqj77hyper563rz</strong></span></pre>

* * *

<pre>4/24
<span style="color: #ba0000;">29 22 14 18 24 33 36 25 35 28 23 26 34 33 34 26 34 33 18
...
<pre>5/24
<span style="color: #ba0000;">zeeteapeafivesevenseeyoubeehefivethreefivepeaho</span>
解法：
谐音分组
zee tea pea fiveseven see you bee he fivethreefive pea ho
zee发音z 
tea发音t 
pea发音p
see发音c
...
bee发音b
he自动联想为e
即<strong><span style="color: #99cc00;">ztp57cube535ph</span></strong></pre>

* * *

<pre>6/24
<span style="color: #ba0000;">ptfraclasbpttasnxetelurn</span>
解法：
元素周期表的原子序数
Pt：铂（78）
Fr：钫（87）
...
得出每个单词对应的十六进制码
45 52 45 37 35 42 45 4e 32 33 35 44 45
换成文本
...
<pre>21/24
<span style="color: #b20000;">2506TQ131913KA2313a2422fJ2519Gb13M13Y</span>
解法：
先按大写、小写、数字分组
25 06 TQ 13 19 13 KA 23 13 a 24 22 f J 25 19 G b 13 M 13 Y
数字换成大写字母（a=0），原大写字母换成小写，原小写字母换成数字（a=0）
ZGtqNTNkaXN0YW5jZTg1NmNy
BASE64解得
<span style="color: #99cc00;"><strong>dkj53distance856cr</strong></span></pre>
...
qwqyttychoeoema
数字部分换成表中数字
<strong><span style="color: #99cc00;">qwq65tycho393ma</span></strong></pre>

* * *

<pre>24/24
Congratulation, you reached the last puzzle
<span style="color: #b20000;">Sysex 1001nnnn        0kkkkkkk</span>
...
实际需要用表中对应数字的上一行替换
65 83 71 56 56 80 65 82 65 83 73 84 69 50 57 52 78 66
ASCII转文本
<span style="color: #99cc00;"><strong>ASG88PARASITE294NB</strong></span></pre>